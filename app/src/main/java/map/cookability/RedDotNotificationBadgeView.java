...
public class RedDotNotificationBadgeView extends View {
    ...
    public RedDotNotificationBadgeView(Context context) {
        super(context);
    }

    public RedDotNotificationBadgeView(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
    }

    public RedDotNotificationBadgeView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
    ...
    public RedDotNotificationBadgeView(Context context, @Nullable AttributeSet attrs, int defStyleAttr, int defStyleRes) {
     ...
     * @return BadgeView
     */
    public RedDotNotificationBadgeView setBadgeBackgroundColor(int color) {
        mBgColor = color;
     ...
     * @return
     */
    public RedDotNotificationBadgeView setBackgroundShape(int shape) {
     ...
     * @return BadgeView
     */
    public RedDotNotificationBadgeView setWidth(int width) {
        this.mWidth = width;
     ...
     * @return BadgeView
     */
    public RedDotNotificationBadgeView setHeight(int height) {
        this.mHeight = height;
     ...
     * @return
     */
    public RedDotNotificationBadgeView setBadgeLayoutParams(int width, int height) {
        this.mWidth = width;
        this.mHeight = height;
     ...
     * @return BadgeView
     */
    public RedDotNotificationBadgeView setBadgeGravity(int gravity) {
        mGravity = gravity;
        FrameLayout.LayoutParams params = (FrameLayout.LayoutParams) getLayoutParams();
     ...
     * @return BadgeView
     */
    public RedDotNotificationBadgeView setBadgeLayoutParams(int width, int height, int gravity) {
        FrameLayout.LayoutParams params = (FrameLayout.LayoutParams) getLayoutParams();
        params.width = dip2px(getContext(), width);
        params.height = dip2px(getContext(), height);
        setLayoutParams(params);
     ...
     * @return
     */
    public RedDotNotificationBadgeView setTextSize(int size) {
     ...
     * @return BadgeView
     */
    public RedDotNotificationBadgeView setTextColor(int color) {
        mTextColor = color;
     ...
     * @return BadgeView
     */
    public RedDotNotificationBadgeView setBadgeText(int count) {
     ...
     * @return BadgeView
     */
    public RedDotNotificationBadgeView setBadgeText(int count, int maxCount, String text) {
        if (count <= maxCount) {
            mText = String.valueOf(count);
        } else {
            mText = text;
     ...
     * @return BadgeView
     */
    public RedDotNotificationBadgeView setBadgeText(String text) {
        mText = text;
        invalidate();
        return this;
    }
     ...
     * @return BadgeView
     */
    public RedDotNotificationBadgeView setBindView(View view) {
        mIsShow = true;
        if (getParent() != null)
